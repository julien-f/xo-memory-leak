...
const { ignoreErrors, promisifyAll } = require('promise-toolbox')
const { v4: generateUuid } = require('uuid')

const asyncMap = require('../async-map')
const { default: Collection, ModelAlreadyExists } = require('../collection')
...
module.exports = class Redis extends Collection {
  constructor({ connection, indexes = [], prefix }) {
    super()

    this.indexes = indexes
    this.prefix = prefix
    const redis = (this.redis = promisifyAll(connection))
